    ...
    <div class="card">
        ...
        <div class="table-responsive">
            <div class="card-body py-3">
                <a href="{{ route('admin.kategori-publikasi.create') }}" class="btn btn-primary">Input Baru Kategori Publikasi</a>
          ...
          <table class="table align-items-center mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <a href="{{ route('admin.kategori-publikasi.edit',$p)}}" class="btn btn-icon btn-2 btn-info">
                        <i class="ni ni-ruler-pencil"></i>
                    </a>
                    <form action="{{ route('admin.kategori-publikasi.destroy',$p)}}" method="POST">
                        @csrf
                        @method('DELETE')
