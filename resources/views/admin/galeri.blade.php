...
<div class="card">
    ...
    <div class="row gx-1">
        <div class="col-auto">
            <div class="h-100">
                <a href="{{ route('admin.galeri.create') }}" class="btn btn-primary">Input Baru Galeri</a>
            </div>
          </div>
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <a href="{{ route('admin.galeri.edit',$p)}}" class="btn btn-icon btn-2 btn-info">
                                    <i class="ni ni-ruler-pencil"></i>
                                </a>
                                <form action="{{ route('admin.galeri.destroy',$p)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
