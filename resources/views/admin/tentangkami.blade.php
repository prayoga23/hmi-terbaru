        ...
        <div class="card-body py-3">
            <form>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="HMI komisariat Dakwah-Ushuludin(dakush) merupakan salah satu komisariat HMI yang dibawah naungan HMI cabang Kudus. HMI Komisariat Dakush menaungi fakultas dakwah dan ushuludin IAIN Kudus."></textarea>
                      </div>
                      <div class="form-group">
