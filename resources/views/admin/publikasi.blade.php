...
<div class="card">
    ...
    <div class="table-responsive">
        <div class="card-body py-3">
            <a href="{{ route('admin.publikasi.create') }}" class="btn btn-primary">Input Baru Publikasi</a>
{{-- OPO AE --}}
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <a href="{{ route('admin.publikasi.edit',$p)}}" class="btn btn-icon btn-2 btn-info">
                                <i class="ni ni-ruler-pencil"></i>
                            </a>
                            <form action="{{ route('admin.publikasi.destroy',$p)}}" method="POST">
                                @csrf
                                @method('DELETE')
