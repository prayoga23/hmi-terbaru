...
<div class="card">
    ...
    <div class="table-responsive">
        <div class="card-body py-3">
            <a href="{{ route('portal.berita.create') }}" class="btn btn-primary">Input Baru Berita</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <a href="{{ route('portal.berita.edit',$p)}}" class="btn btn-icon btn-2 btn-info">
                                <i class="ni ni-ruler-pencil"></i>
                            </a>
                            <form action="{{ route('portal.berita.destroy',$p)}}" method="POST">
                                @csrf
                                @method('DELETE')
