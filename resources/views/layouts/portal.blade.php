...
<head>
    ...
    <meta name="description" content="Website HMI">
    <meta name="author" content="Prayoga Nugroho Pangestu">
    ...
    <aside
        ...
        <div class="sidenav-header">
            <a class="navbar-brand m-0" href="#">
                ...
                <span class="font-weight-bold">Portal Website HMI</span>
            </a>
        </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="applicationsExamples">
                        <ul class="nav ms-4">
                            {{-- <li class="nav-item ">
                                <a class="nav-link {{ Nav::isRoute('tentangkami') }}" href="{{ route('tentangkami') }}">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link {{ Nav::isRoute('admin.berita.index') }}"
                                    href="{{ route('portal.berita.index') }}">
                                    <span class="sidenav-mini-icon"> W </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link {{ Nav::isRoute('admin.galeri.index') }}"
                                    href="{{ route('portal.galeri.index') }}">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item dropdown pe-2 d-flex align-items-center ">
                            <a href="javascript:;" class="nav-link text-white p-0 dropdown-toggle"
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            made with <i class="fa fa-heart"></i> by <b>Prayoga Nugroho Pangestu</b>
                        </div>
                    </div>
                </div>
            </div>
